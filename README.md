...
[Odpověď - datový podklad:](https://github.com/PetraRaul/sql_project/blob/main/SQL_question_2.sql) Z výsledků vidíme, že jak v případě mléka, tak v případě chleba se zvýšilo množství, které si za průměrnou mzdu lze koupit v roce 2018 oproti množství, které bylo možné koupit v roce 2006. U mléka si můžeme v roce 2018 nakoupit o 263,79 litrů více, než bylo možné v roce 2006. V případě chleba si můžeme v roce 2018 koupit o 110 kg více, než v roce 2006. Skutečnost, že možné nakoupené množství mléka roste výrazně rychleji, než možné nakoupené množství chleba je dána výraznějším nárůstem kupní ceny chleba, než kupní ceny mléka, jak dokládá graf níže.

![Price_milk_and_bread.jpg](https://github.com/PetraRaul/sql_project/blob/main/Price_milk%20and%20bread.jpg)

### Otázka 3: Která kategorie potravin zdražuje nejpomaleji (je u ní nejnižší percentuální meziroční nárůst)? 
[Odpověď - datový podklad:](https://github.com/PetraRaul/sql_project/blob/main/SQL_question_3.sql) Zde jsem se rozhodla nekomplikovat situaci jednotlivými roky a rovnou jsem porovnala data mezi lety 2006 a 2018 (pro jakostní víno bílé data mezi rokem 2015 a 2018). Nejpomaleji zdražovaly banány žluté, u nichž došlo mezi lety 2006 a 2018 k nárůstu ceny o 7,36 %. Je však nutné zmínit, že existují dvě potraviny, které ve sledovaném období nezdražily, ale naopak zlevnily. Jsou jimi: cukr krystalový (pokles ceny o 27,52 %) a rajská jablka červená kulatá (pokles ceny o 23,07 %).

![Price_development.jpg](https://github.com/PetraRaul/sql_project/blob/main/Price_development.jpg)

### Otázka 4: Existuje rok, ve kterém byl meziroční nárůst cen potravin výrazně vyšší než růst mezd (větší než 10 %)?
[Odpověď - datový podklad:](https://github.com/PetraRaul/sql_project/blob/main/SQL_question_4.sql) Před zodpovězením samotné otázky bych jen zmínila, že jsem z dat vyřadila položku „Jakostní víno bílé“, jelikož u ní máme sledované hodnoty k dispozici až od roku 2015. Pokud bych položku v datech ponechala, nebyla by analýza prováděna na srovnatelných datech. Žádný rok, ve kterém by byl zaznamenán výrazně vyšší růst cen potravin než růst mezd, neexistuje. Obecně lze říci, že ceny potravin rostly rychleji než mzdy pouze v letech 2011, 2012, 2017 a 2013 (v tomto roce dokonce mzdy nepatrně poklesly oproti roku 2012). V letech 2009, 2015 a 2016 pak ceny klesaly, zatímco mzdy rostly – nejmarkantnější rozdíl byl viditelný v roce 2009, kdy ceny klesly o 6,41%, zatímco mzdy vzrostly o 3,37%.
...
[Odpověď - datový podklad:](https://github.com/PetraRaul/sql_project/blob/main/SQL_question_5.sql) Největší nárůst HDP lze sledovat v letech 2007, 2015 a 2017. Mzdy v daných rocích vzrostly, ale ještě výrazněji vzrostly mzdy v letech následujících (2008, 2016 a 2018), ač se HDP v těchto následujících letech snížilo. Lze si také všimnout, že vysoký nárůst HDP v roce 2007 měl pozitivní dopad na mzdy ještě v roce 2009, kdy HDP výrazně pokleslo oproti roku 2008, ale mzdy i nadále zaznamenaly nárůst (mírnější, než v letech předchozích).V případě cen je situace následující. V roce 2017 vzrostlo HDP nejvíce a zároveň vzrostly nejvíce i ceny. To samé však nelze říci o roce 2015, kdy HDP zaznamenalo druhý nejvýraznější nárůst, ale ceny poklesly a pokles cen proběhl i v roce následujícím (ne tak významný jako v roce 2015). 

Obecně lze říci, že HDP má výraznější vliv na mzdy, než na ceny. S určitostí lze však říci, že faktorů, které ovlivňují růst a pokles mezd a růst a pokles cen existuje více a dávat do souvislosti výkyvy těchto dvou ukazatelů pouze s vývojem HDP by bylo zkratkovité a zjednodušující.
